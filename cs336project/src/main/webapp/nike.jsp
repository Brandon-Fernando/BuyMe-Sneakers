...
<body>
    ...
    <div class="container" style="text-align: center">
    	<form class="form-inline" method="post" action="nike.jsp">
   ...
   try{
	   ...
	   if(searched == null){
		   ...
		   if(sortOption == null){
			   ...
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' ORDER BY name";
		   }else if(sortOption.equals("Mens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Mens' AND brand = 'Nike'";
		   }else if(sortOption.equals("Womens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Womens' AND brand = 'Nike'";
		   }else if(sortOption.equals("lowToHigh")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' ORDER BY startingPrice";
		   }else if(sortOption.equals("highToLow")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' ORDER BY startingPrice DESC";
		   }else if(sortOption.equals("open")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Open' AND brand = 'Nike'";
		   }else if(sortOption.equals("closed")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Closed' AND brand = 'Nike'";
		   }else{
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike'";
		   }
	 ...
	 %>
		 ...
		 <form class="inline" method="post" action="nike.jsp">
	 ...
	 <%}else{
		 String sortOption = request.getParameter("sortByOptions");
		   String sortQuery = null;
		   if(sortOption == null){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("Name")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' AND name LIKE '%"+searched+"%' ORDER BY name";
		   }else if(sortOption.equals("Mens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Mens' AND brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("Womens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Womens' AND brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("lowToHigh")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' AND name LIKE '%"+searched+"%' ORDER BY startingPrice";
		   }else if(sortOption.equals("highToLow")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' AND name LIKE '%"+searched+"%' ORDER BY startingPrice DESC";
		   }else if(sortOption.equals("open")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Open' AND brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("closed")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Closed' AND brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }else{
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Nike' AND name LIKE '%"+searched+"%'";
		   }
		   PreparedStatement ps2 = con.prepareStatement(sortQuery);
	 ...
	 %>
	 <h2>All Nike <%=searched %> Listings</h2>
		 <form class="inline" method="post" action="nike.jsp">
	    	<select name="sortByOptions" id="sortByOptions">
	    		<option value="None">---</option>
	    		<option value="Name">Name</option>
