...
<body>
	<h1 style="text-align: center">Adidas Shoes</h1> 
    ...
    <div class="container" style="text-align: center">
    	<form class="form-inline" method="post" action="adidas.jsp">
   ...
   try{
	   ...
	   if(searched == null){
		   ...
		   if(sortOption == null){
			   ...
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' ORDER BY name";
		   }else if(sortOption.equals("Mens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Mens' AND brand = 'Adidas'";
		   }else if(sortOption.equals("Womens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Womens' AND brand = 'Adidas'";
		   }else if(sortOption.equals("lowToHigh")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' ORDER BY startingPrice";
		   }else if(sortOption.equals("highToLow")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' ORDER BY startingPrice DESC";
		   }else if(sortOption.equals("open")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Open' AND brand = 'Adidas'";
		   }else if(sortOption.equals("closed")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Closed' AND brand = 'Adidas'";
		   }else{
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas'";
		   }
	 ...
	 %>
	 	<h2>All Adidas Listings</h2>
		 <form class="inline" method="post" action="adidas.jsp">
	    ...
	    <table style="border-collapse: collapse; width: 100%">
		 	<tr> 
		 		...
		 		<td style="border: 3px solid #dddddd; text-align: left; padding: 8px;">Listing ID</td>
		 ...
		 <tr>
	 		...
	 		<td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><%= getListings.getString("listID")%></td>
	 ...
	 <%}else{
		 String sortOption = request.getParameter("sortByOptions");
		   String sortQuery = null;
		   if(sortOption == null){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("Name")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' AND name LIKE '%"+searched+"%' ORDER BY name";
		   }else if(sortOption.equals("Mens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Mens' AND brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("Womens")){
			   sortQuery = "SELECT * FROM createListing WHERE gender = 'Womens' AND brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("lowToHigh")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' AND name LIKE '%"+searched+"%' ORDER BY startingPrice";
		   }else if(sortOption.equals("highToLow")){
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' AND name LIKE '%"+searched+"%' ORDER BY startingPrice DESC";
		   }else if(sortOption.equals("open")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Open' AND brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }else if(sortOption.equals("closed")){
			   sortQuery = "SELECT * FROM createListing WHERE status = 'Closed' AND brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }else{
			   sortQuery = "SELECT * FROM createListing WHERE brand = 'Adidas' AND name LIKE '%"+searched+"%'";
		   }
		   PreparedStatement ps2 = con.prepareStatement(sortQuery);
	 ...
	 %>
	 <h2>All Adidas <%=searched %> Listings</h2>
		 <form class="inline" method="post" action="adidas.jsp">
	    	<select name="sortByOptions" id="sortByOptions">
	    		<option value="None">---</option>
	    		<option value="Name">Name</option>
